<?php ob_start() ?>
<h3>Gestión-><a class="enlaceVerde" href="index.php?ctl=ProveedoresInicio">Proveedores</a>->Editar</h3>
<hr>
<form method="post" action="index.php?ctl=ProveedoresEditar&id=<?php echo htmlspecialchars($proveedor['IDProveedor']); ?>">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control" id="descripcion" name="descripcion" rows="3" required><?php echo htmlspecialchars($proveedor['Descripcion']); ?></textarea>
    </div>
